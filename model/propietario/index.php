...
session_start();
$query = "SELECT * FROM persona, tipo_usuario WHERE identificacion = '" . $_SESSION['identificacion'] . "' AND persona.id_tip_usuario = tipo_usuario.id_tip_usuario";
...
<body onload="form1.usuario.focus()">
    ...
    <div class="login-box">
        ...
        <h1>REPORTE POR FECHAS <?php echo $row_usuarios['nombres']; ?> <?php echo $row_usuarios['tipo_usuario']; ?></h1>
        <!--Inserta titulo-->
        <form method="POST" name="form1" id="form1" autocomplete="off">
            ...
            <table width="1095" border="1">
                <tr>
                    ...
                    <input type="text" value="<?php echo $row_usuarios['tipo_usuario']; ?>">
